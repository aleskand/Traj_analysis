        ...
        if len(self.frame_list) != 0:
            ...
            if full_output:
                ...
                for key in self.knot_dict:
                    full_knot_dict[key] = {}
                    full_knot_dict[key]["Topology type"] = self.knot_dict[key][0]
                    ...
                    if self.knot_dict[key][3] == 0:
                        full_knot_dict[key]["Lopping via slipknot"] = True
                    else:
                        full_knot_dict[key]["Lopping via slipknot"] = False
